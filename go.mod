module github.com/huione-labs/xone
...
replace (
	github.com/cometbft/cometbft => github.com/xone-ddd/cometbft v1.0.1
	// use cosmos fork of keyring
	github.com/99designs/keyring => github.com/cosmos/keyring v1.2.0
	// use Cosmos-SDK fork to enable Ledger functionality
	github.com/cosmos/cosmos-sdk => github.com/huione-labs/cosmos-sdk v0.47.5-evm-cointype
	// use Evmos geth fork
	github.com/ethereum/go-ethereum => github.com/huione-labs/go-ethereum v1.10.26-evmos-rc2
	// use Evmos evmos fork
	github.com/evmos/evmos/v16 => github.com/huione-labs/evmos/v16 v16.0.1-chainid
